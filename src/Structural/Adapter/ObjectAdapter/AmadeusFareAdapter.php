...
/**
 * GoF Object Adapter bridging AmadeusSoapService to FlightFareDataSourceInterface.
 */
class AmadeusFareAdapter implements FlightFareDataSourceInterface
{
    /** @var AmadeusSoapService */
    private AmadeusSoapService $soapService;

    /**
     * @param AmadeusSoapService $soapService Incompatible legacy service dependency.
     */
    public function __construct(AmadeusSoapService $soapService)
    {
    ...
    {
        $xmlRaw = $this->soapService->getLowFareSearchXml();
